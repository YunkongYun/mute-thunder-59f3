...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-thunder-59f3)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mute-thunder-59f3
```

A live public deployment of this template is available at [https://mute-thunder-59f3.templates.workers.dev](https://mute-thunder-59f3.templates.workers.dev)
